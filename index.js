...
document.addEventListener("click", function(e){
    if(e.target.dataset.like){
       LikeClick(e.target.dataset.like) 
        ...
        RepostClick(e.target.dataset.repost)
    }
...
function PostBtnClick(){
    ...
    if(postInput.value){
        postsData.unshift({
            handle: `@ValiantLearner108`,
            profilePic: `images/al.ghazali.png`,
            likes: 0,
            reposts: 0,
...
function getFeedHtml(){
    ...
    postsData.forEach(function(post){
        ...
        const likeIconClass = post.isLiked ? "liked" : ""
        
        const retweetIconClass = post.isReposted ? "reposted" : ""
